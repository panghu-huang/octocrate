...
use octocrate_infra::{ExpirableToken, GithubAPIClient, GithubAPIConfig};
use std::sync::Arc;
...
pub struct GithubAPI {
  ...
  pub users: users::GithubUserAPI,
  pub actions: actions::GithubActionAPI,
}
...
impl GithubAPI {
  pub fn new(api_config: GithubAPIConfig) -> Self {
    ...
    Self {
      ...
      users: users::GithubUserAPI::new(client.clone()),
      actions: actions::GithubActionAPI::new(client.clone()),
    }
  }
