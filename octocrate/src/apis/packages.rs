...
impl GitHubPackagesAPI {
  ...
  pub fn get_package_version_for_organization(
    ...
    let package_type = package_type.to_string();
    let url = format!("/orgs/{org}/packages/{package_type}/{package_name}/versions/{package_version_id}");
  ...
  pub fn restore_package_version_for_authenticated_user(
    ...
    let package_version_id = package_version_id.into();
    let package_type = package_type.to_string();
    let url = format!("/user/packages/{package_type}/{package_name}/versions/{package_version_id}/restore");
  ...
  pub fn get_package_version_for_user(
    ...
    let username = username.into();
    let package_type = package_type.to_string();
    let url = format!("/users/{username}/packages/{package_type}/{package_name}/versions/{package_version_id}");
  ...
  pub fn restore_package_version_for_org(
    ...
    let package_version_id = package_version_id.into();
    let package_type = package_type.to_string();
    let url = format!("/orgs/{org}/packages/{package_type}/{package_name}/versions/{package_version_id}/restore");
  ...
  pub fn list_packages_for_authenticated_user(
    ...
    Request::<(), PackagesListPackagesForAuthenticatedUserQuery, PackageArray>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn get_all_package_versions_for_package_owned_by_authenticated_user(
    &self,
    package_type: impl Into<PackagesGetAllPackageVersionsForPackageOwnedByAuthenticatedUserParametersPackageType>,
    package_name: impl Into<String>,
  ) -> Request<(), PackagesGetAllPackageVersionsForPackageOwnedByAuthenticatedUserQuery, PackageVersionArray> {
    let package_type = package_type.into();
    let package_name = package_name.into();
    let package_type = package_type.to_string();
    let url = format!("/user/packages/{package_type}/{package_name}/versions");

    Request::<(), PackagesGetAllPackageVersionsForPackageOwnedByAuthenticatedUserQuery, PackageVersionArray>::builder(&self.config)
      .get(url)
      .build()
  }
