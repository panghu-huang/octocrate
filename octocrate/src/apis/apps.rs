...
impl GitHubAppsAPI {
  ...
  pub fn list_installation_requests_for_authenticated_app(
    &self,
  ) -> Request<(), AppsListInstallationRequestsForAuthenticatedAppQuery, IntegrationInstallationRequestArray> {
    let url = format!("/app/installation-requests");

    Request::<(), AppsListInstallationRequestsForAuthenticatedAppQuery, IntegrationInstallationRequestArray>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn list_installations_for_authenticated_user(
    &self,
  ) -> Request<(), AppsListInstallationsForAuthenticatedUserQuery, AppsListInstallationsForAuthenticatedUserResponse> {
    let url = format!("/user/installations");

    Request::<(), AppsListInstallationsForAuthenticatedUserQuery, AppsListInstallationsForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  ) -> Request<(), AppsListInstallationReposForAuthenticatedUserQuery, AppsListInstallationReposForAuthenticatedUserResponse> {
    let installation_id = installation_id.into();
    let url = format!("/user/installations/{installation_id}/repositories");

    Request::<(), AppsListInstallationReposForAuthenticatedUserQuery, AppsListInstallationReposForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn create_installation_access_token(
    ...
    Request::<AppsCreateInstallationAccessTokenRequest, (), InstallationToken>::builder(&self.config)
      .post(url)
      .build()
  }
  ...
  pub fn list_plans(
    &self,
  ) -> Request<(), AppsListPlansQuery, MarketplaceListingPlanArray> {
  ...
  pub fn list_accounts_for_plan_stubbed(
    ...
    Request::<(), AppsListAccountsForPlanStubbedQuery, MarketplacePurchaseArray>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn list_installations(
    &self,
  ) -> Request<(), AppsListInstallationsQuery, InstallationArray> {
  ...
  pub fn list_subscriptions_for_authenticated_user_stubbed(
    &self,
  ) -> Request<(), AppsListSubscriptionsForAuthenticatedUserStubbedQuery, UserMarketplacePurchaseArray> {
  ...
  pub fn list_repos_accessible_to_installation(
    &self,
  ) -> Request<(), AppsListReposAccessibleToInstallationQuery, AppsListReposAccessibleToInstallationResponse> {
    let url = format!("/installation/repositories");

    Request::<(), AppsListReposAccessibleToInstallationQuery, AppsListReposAccessibleToInstallationResponse>::builder(&self.config)
      .get(url)
      .build()
  }
