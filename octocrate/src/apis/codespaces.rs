...
impl GitHubCodespacesAPI {
  ...
  pub fn get_public_key_for_authenticated_user(
    &self,
  ) -> Request<(), (), CodespacesUserPublicKey> {
  ...
  ) -> Request<(), CodespacesRepoMachinesForAuthenticatedUserQuery, CodespacesRepoMachinesForAuthenticatedUserResponse> {
    let owner = owner.into();
    let repo = repo.into();
    let url = format!("/repos/{owner}/{repo}/codespaces/machines");

    Request::<(), CodespacesRepoMachinesForAuthenticatedUserQuery, CodespacesRepoMachinesForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn list_selected_repos_for_org_secret(
    ...
    org: impl Into<String>,
    secret_name: impl Into<String>,
  ) -> Request<(), CodespacesListSelectedReposForOrgSecretQuery, CodespacesListSelectedReposForOrgSecretResponse> {
    let org = org.into();
    let secret_name = secret_name.into();
    let url = format!("/orgs/{org}/codespaces/secrets/{secret_name}/repositories");

    Request::<(), CodespacesListSelectedReposForOrgSecretQuery, CodespacesListSelectedReposForOrgSecretResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn create_or_update_secret_for_authenticated_user(
    ...
    Request::<CodespacesCreateOrUpdateSecretForAuthenticatedUserRequest, (), EmptyObject>::builder(&self.config)
      .put(url)
      .build()
  }
  ...
  pub fn list_in_organization(
    ...
    Request::<(), CodespacesListInOrganizationQuery, CodespacesListInOrganizationResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn list_secrets_for_authenticated_user(
    &self,
  ) -> Request<(), CodespacesListSecretsForAuthenticatedUserQuery, CodespacesListSecretsForAuthenticatedUserResponse> {
    let url = format!("/user/codespaces/secrets");

    Request::<(), CodespacesListSecretsForAuthenticatedUserQuery, CodespacesListSecretsForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn create_with_pr_for_authenticated_user(
    ...
    Request::<CodespacesCreateWithPrForAuthenticatedUserRequest, (), Codespace>::builder(&self.config)
      .post(url)
      .build()
  }
  ...
  pub fn list_org_secrets(
    ...
    Request::<(), CodespacesListOrgSecretsQuery, CodespacesListOrgSecretsResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn list_in_repository_for_authenticated_user(
    ...
    owner: impl Into<String>,
    repo: impl Into<String>,
  ) -> Request<(), CodespacesListInRepositoryForAuthenticatedUserQuery, CodespacesListInRepositoryForAuthenticatedUserResponse> {
    let owner = owner.into();
    let repo = repo.into();
    let url = format!("/repos/{owner}/{repo}/codespaces");

    Request::<(), CodespacesListInRepositoryForAuthenticatedUserQuery, CodespacesListInRepositoryForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn create_with_repo_for_authenticated_user(
    ...
    Request::<CodespacesCreateWithRepoForAuthenticatedUserRequest, (), Codespace>::builder(&self.config)
      .post(url)
      .build()
  }
  ...
  pub fn list_repositories_for_secret_for_authenticated_user(
    ...
    Request::<(), (), CodespacesListRepositoriesForSecretForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn set_repositories_for_secret_for_authenticated_user(
    ...
    NoContentRequest::<CodespacesSetRepositoriesForSecretForAuthenticatedUserRequest, ()>::builder(&self.config)
      .put(url)
      .build()
  }
  ...
  pub fn list_repo_secrets(
    ...
    Request::<(), CodespacesListRepoSecretsQuery, CodespacesListRepoSecretsResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn pre_flight_with_repo_for_authenticated_user(
    ...
    owner: impl Into<String>,
    repo: impl Into<String>,
  ) -> Request<(), CodespacesPreFlightWithRepoForAuthenticatedUserQuery, CodespacesPreFlightWithRepoForAuthenticatedUserResponse> {
    let owner = owner.into();
    let repo = repo.into();
    let url = format!("/repos/{owner}/{repo}/codespaces/new");

    Request::<(), CodespacesPreFlightWithRepoForAuthenticatedUserQuery, CodespacesPreFlightWithRepoForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn list_for_authenticated_user(
    &self,
  ) -> Request<(), CodespacesListForAuthenticatedUserQuery, CodespacesListForAuthenticatedUserResponse> {
  ...
  pub fn codespace_machines_for_authenticated_user(
    ...
    Request::<(), (), CodespacesCodespaceMachinesForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn list_devcontainers_in_repository_for_authenticated_user(
    ...
    owner: impl Into<String>,
    repo: impl Into<String>,
  ) -> Request<(), CodespacesListDevcontainersInRepositoryForAuthenticatedUserQuery, CodespacesListDevcontainersInRepositoryForAuthenticatedUserResponse> {
    let owner = owner.into();
    let repo = repo.into();
    let url = format!("/repos/{owner}/{repo}/codespaces/devcontainers");

    Request::<(), CodespacesListDevcontainersInRepositoryForAuthenticatedUserQuery, CodespacesListDevcontainersInRepositoryForAuthenticatedUserResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn get_codespaces_for_user_in_org(
    ...
    org: impl Into<String>,
    username: impl Into<String>,
  ) -> Request<(), CodespacesGetCodespacesForUserInOrgQuery, CodespacesGetCodespacesForUserInOrgResponse> {
    let org = org.into();
    let username = username.into();
    let url = format!("/orgs/{org}/members/{username}/codespaces");

    Request::<(), CodespacesGetCodespacesForUserInOrgQuery, CodespacesGetCodespacesForUserInOrgResponse>::builder(&self.config)
      .get(url)
      .build()
  }
