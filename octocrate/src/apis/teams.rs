...
impl GitHubTeamsAPI {
  ...
  pub fn list_discussion_comments_in_org(
    ...
    Request::<(), TeamsListDiscussionCommentsInOrgQuery, TeamDiscussionCommentArray>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn create_discussion_comment_in_org(
    ...
    Request::<TeamsCreateDiscussionCommentInOrgRequest, (), TeamDiscussionComment>::builder(&self.config)
      .post(url)
      .build()
  }
  ...
  pub fn list_pending_invitations_in_org(
    ...
    Request::<(), TeamsListPendingInvitationsInOrgQuery, OrganizationInvitationArray>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn get_discussion_comment_in_org(
    ...
    let url = format!("/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}");
  ...
  pub fn update_discussion_comment_in_org(
    ...
    Request::<TeamsUpdateDiscussionCommentInOrgRequest, (), TeamDiscussionComment>::builder(&self.config)
      .patch(url)
      .build()
  }
  ...
  pub fn update_discussion_comment_legacy(
    ...
    Request::<TeamsUpdateDiscussionCommentLegacyRequest, (), TeamDiscussionComment>::builder(&self.config)
      .patch(url)
      .build()
  }
  ...
  pub fn add_or_update_membership_for_user_legacy(
    ...
    Request::<TeamsAddOrUpdateMembershipForUserLegacyRequest, (), TeamMembership>::builder(&self.config)
      .put(url)
      .build()
  }
  ...
  pub fn list_pending_invitations_legacy(
    ...
    Request::<(), TeamsListPendingInvitationsLegacyQuery, OrganizationInvitationArray>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn list(
    &self,
    org: impl Into<String>,
  ) -> Request<(), TeamsListQuery, TeamArray> {
    let org = org.into();
  ...
  pub fn create(
    &self,
    org: impl Into<String>,
  ) -> Request<TeamsCreateRequest, (), FullTeam> {
    let org = org.into();
    let url = format!("/orgs/{org}/teams");
  ...
  pub fn list_discussion_comments_legacy(
    ...
    Request::<(), TeamsListDiscussionCommentsLegacyQuery, TeamDiscussionCommentArray>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn create_discussion_comment_legacy(
    ...
    Request::<TeamsCreateDiscussionCommentLegacyRequest, (), TeamDiscussionComment>::builder(&self.config)
      .post(url)
      .build()
  }
  ...
  pub fn add_or_update_membership_for_user_in_org(
    ...
    Request::<TeamsAddOrUpdateMembershipForUserInOrgRequest, (), TeamMembership>::builder(&self.config)
      .put(url)
      .build()
  }
