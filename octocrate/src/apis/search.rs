...
impl GitHubSearchAPI {
  ...
  pub fn topics(
    &self,
  ) -> Request<(), SearchTopicsQuery, SearchTopicsResponse> {
  ...
  pub fn users(
    &self,
  ) -> Request<(), SearchUsersQuery, SearchUsersResponse> {
  ...
  pub fn labels(
    &self,
  ) -> Request<(), SearchLabelsQuery, SearchLabelsResponse> {
  ...
  pub fn commits(
    &self,
  ) -> Request<(), SearchCommitsQuery, SearchCommitsResponse> {
  ...
  pub fn issues_and_pull_requests(
    ...
    Request::<(), SearchIssuesAndPullRequestsQuery, SearchIssuesAndPullRequestsResponse>::builder(&self.config)
      .get(url)
      .build()
  }
  ...
  pub fn repos(
    &self,
  ) -> Request<(), SearchReposQuery, SearchReposResponse> {
  ...
  pub fn code(
    &self,
  ) -> Request<(), SearchCodeQuery, SearchCodeResponse> {
